"""
Django settings for qatestuser_2 project.
...
ROOT_URLCONF = 'qatestuser_2.urls'
...
WSGI_APPLICATION = 'qatestuser_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qatestuser_2 API",
    "DESCRIPTION": "API documentation for qatestuser_2 App",
    "VERSION": "v1",
}
